...
- Want to understand specific file formats? Read [File Format Reference](../reference/file-formats)
- Want to understand where data is stored? Read [Data Storage Locations](../reference/data-locations)
