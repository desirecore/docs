---
title: What is Delegation Interaction
description: Learn about the core philosophy of DesireCore's delegation interaction—cultivating your AI agent like an apprentice, rather than issuing commands to a tool.
keywords: [delegation interaction, delegation, apprenticeship, AI interaction, DesireCore]
---
...
:::info Next Step
Ready to start? Go to the [Six Primitives Complete Guide](./02-six-primitives.md) to learn how to interact with your agent.
:::
