...
- **Hidden Demo Brand Toggle**: Press Alt+Shift+B to switch between the demo brand (including Logo, the "Chief Dispatcher" core agent, and dedicated avatar) and the default brand. The choice is retained in the current instance.
