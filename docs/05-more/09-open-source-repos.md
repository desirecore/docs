...
| 仓库 | 说明 | 状态 |
|------|------|------|
| [desirecore](https://github.com/desirecore/desirecore) | DesireCore 客户端软件主仓库 | 稳定后全面开源 |
| [desirecore-hostagent](https://github.com/desirecore/desirecore-hostagent) | 跨平台 Host Agent，用于 Windows、macOS、Linux、Android、iOS、HarmonyOS 的 Host 常驻服务，实现操作系统的权限获取、GUI 操作与命令执行 | 稳定后开源 |
