...
![三层能力体系](/img/user-guide/capabilities/tool-layers.svg)
...
![权限层级](/img/user-guide/capabilities/permission-layers.svg)
...
智能体的 `agent.json` 也可以通过 `tool_permissions.allowed` 或 `tool_permissions.denied` 为单个智能体限制工具范围。
