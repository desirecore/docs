...
除非你要求“先只写计划”，智能体会在当前授权范围内逐步执行。你可以实时看到进展；遇到计划中标注的人闸门时，它仍会为那个具体动作单独请求确认：
...
![原语选择决策树](/img/user-guide/teaching/primitive-decision-tree.svg)
