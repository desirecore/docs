---
title: Linux 安装
description: 在 Linux 上使用 AppImage 安装和运行 DesireCore，支持 x64 和 ARM64 架构。
keywords: [Linux, 安装, AppImage, Ubuntu, Fedora, ARM64]
---

# Linux 安装

本指南介绍如何在 Linux 上安装 DesireCore。DesireCore 以 AppImage 格式分发，支持 x64 和 ARM64 架构，兼容大多数主流 Linux 发行版。
